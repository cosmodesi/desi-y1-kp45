...
if __name__ == "__main__":
    ...
    allnames = []
    mocknames = ['desi_kp4_abacus_cubicbox_covapt_gaussian_pk', 'desi_kp4_abacus_cubicbox_xi']
    for i, mockname in enumerate(mocknames):

        for hod in range(7):
            
            for person in ["antoine", "sihan"]:
                
                if hod == 0 and person == "sihan":
                    continue
                    
                if hod == 6 and person == "antoine":
                    continue
                ...
                for recon in [None, "sym"]:
                    ...
                    if "_pk" in mockname:
                        dataset = PowerSpectrum_DESI_KP4(
                            ...
                            datafile=mockname + f"_hod_{hod}_{person}_elg.pkl",
