...
if __name__ == "__main__":
    ...
    for i, mocktype in enumerate(mocktypes):
        ...
        for recon in [None, "sym"]:
            ...
            dataset_pk = PowerSpectrum_DESI_KP4(
                ...
                max_k=0.30,
                mocktype=mocktype,
                redshift_bin=1,            # There's only one redshift bin in this dataset
            ...
            # We don't have CV Xi included yet, so only load the correlation function for normal abacus_cubicbox
            ...
            # Do the same for the correlation function model
            if "abacus_cubicbox_cv" not in mocktype:
